function [images, phrases] = getRelations(cap)
...
%         % assemble phrase
%         charphrase(seg1s:seg1e) = names(:,i);
%         charphrase(seg2s:seg2e) = relstrings(:,5);
%         charphrase(seg3s:seg3e) = names(:,j);
%         
%         phrases(currIm) = cellstr(charphrase);
%         
%         % assemble image
%         images((imrows:imrowe)+2,(imcols:imcole)+2,currIm) = pics(:,:,i);
%         images((imrows:imrowe)-2,(imcols:imcole)-2,currIm) = min(1, pics(:,:,j) + images((imrows:imrowe)-2,(imcols:imcole)-2,currIm));
%         
%         % next im
%         currIm = currIm+1;
%     end
